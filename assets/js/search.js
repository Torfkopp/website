        ...
        `<li class="mb-2">
          ...
          ${linkconfig} tabindex="0">
            <div class="grow">
              ...
              <div class="text-sm text-neutral-500 dark:text-neutral">${value.item.section}<span class="px-2 text-primary-500">&middot;</span>${value.item.date? value.item.date : ""}</span></div>
